---
title: $ API
description: The Zod-style TypeScript-first schema API for Mondoose
---

# $ API

The `$` API provides a modern, Zod-inspired approach to defining schemas in Mondoose. It offers excellent TypeScript integration with automatic type inference.

## Overview

```typescript
import { $, model } from 'mondoose'
