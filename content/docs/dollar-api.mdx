---
title: $ API
description: The Zod-style TypeScript-first schema API for Mongoose.do
---

# $ API

The `$` API provides a modern, Zod-inspired approach to defining schemas in Mongoose.do. It offers excellent TypeScript integration with automatic type inference.
