...
Schemas define the structure and validation rules for your documents. Mondoose supports both Mongoose-style and `$` API schema definitions.
...
```typescript
import { Schema, Types } from 'mondoose'
