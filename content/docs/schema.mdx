...
Schemas define the structure and validation rules for your documents. Mongoose.do supports both Mongoose-style and `$` API schema definitions.
...
```typescript
import { Schema, Types } from 'mongoose.do'
