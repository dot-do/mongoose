...
description: Install and configure Mondoose for your Cloudflare Workers project
---

# Getting Started

Mondoose is a Mongoose-compatible ODM for Cloudflare Durable Objects. It provides two APIs:
...
Mondoose is designed specifically for Cloudflare Workers with Durable Objects:
...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    // Create a mondoose instance with the Worker environment
...
Mondoose is built with TypeScript and provides excellent type inference:

```typescript
import { $, model, Document } from 'mondoose'
