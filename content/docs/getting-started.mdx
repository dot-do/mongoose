...
description: Install and configure Mongoose.do for your Cloudflare Workers project
---

# Getting Started

Mongoose.do is a Mongoose-compatible ODM for Cloudflare Durable Objects. It provides two APIs:
...
Mongoose.do is designed specifically for Cloudflare Workers with Durable Objects:
...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    // Create a mongoose instance with the Worker environment
...
Mongoose.do is built with TypeScript and provides excellent type inference:
